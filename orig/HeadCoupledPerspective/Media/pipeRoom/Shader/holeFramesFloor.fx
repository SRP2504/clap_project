...
float4 DIFFUSETEX( PS_INPUT input )
{
    return 
#ifdef _CPUT
texture_DM.Sample( SAMPLER0, (((input.UV0)) *(7)) )
#else
tex2D( SAMPLER0, (((input.UV0)) *(7)) )
#endif
;
}
...
float4 SPECULARTEX( PS_INPUT input )
{
    return 
#ifdef _CPUT
texture_SM.Sample( SAMPLER0, (((input.UV0)) *(7)) )
#else
tex2D( SAMPLER3, (((input.UV0)) *(7)) )
#endif
;
}
...
float4 NORMAL( PS_INPUT input )
{
    return ((
#ifdef _CPUT
texture_NM.Sample( SAMPLER0, (((input.UV0)) *(7)) )
#else
tex2D( SAMPLER2, (((input.UV0)) *(7)) )
#endif
) *(2)) -(1);
}
