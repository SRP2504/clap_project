...
#else
    texture2D diffuseTexture < string Name = "diffuseTexture"; string UIName = "diffuseTexture"; string ResourceType = "2D";>;
    sampler2D SAMPLER0 = sampler_state{ texture = (diffuseTexture);};
#endif
...
float4 DIFFUSE( PS_INPUT input )
{
    return 
#ifdef _CPUT
diffuseTexture.Sample( SAMPLER0, (((input.UV0)) *(1)) )
#else
